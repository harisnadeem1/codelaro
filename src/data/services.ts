...
export const SERVICES: Service[] = [
	...
	//AI & automation
	{
		slug: 'ai-automation',
		title: 'AI & Automation',
		tagline: 'Practical AI and automation solutions that reduce repetitive work and speed up decision-making.',
		summary:
	...
	//Custom software development
	{
		...
		tagline: 'Purpose-built software that streamlines complex workflows and adapts as your business evolves.',
		summary:
	...
	//web development
	{
		...
		tagline: 'Fast, responsive websites built to engage customers and turn visits into lasting business growth.',
		summary:
		...
		//Cloud & DevOps
	{
		slug: 'cloud-devops',
		title: 'Cloud & DevOps',
		tagline: 'Cloud infrastructure and DevOps workflows built for reliable deployments and effortless scaling.',
		summary:
	...
	//Mobile app development
	{
		...
		tagline: 'Intuitive mobile apps designed for smooth experiences, reliable performance, and everyday use.',
		summary:
	...
	//SaaS development
	{
		...
		tagline: 'Scalable SaaS platforms that simplify operations, delight users, and support business growth.',
		summary:
	...
	//Data & analytics
	{
		...
		tagline: 'Clear dashboards and data solutions that turn complex information into actionable insights.',
		summary:
	...
	//E-commerce development
	{
		...
		tagline: 'High-performing online stores designed to simplify shopping, increase sales, and support growth.',
		summary:
		...
		//API & system integration
	{
		...
		tagline: 'Reliable API integrations that connect your systems, automate data flows, and reduce manual work.',
		summary:
	...
	//UI/UX design
	{
		slug: 'ui-ux-design',
		title: 'UI/UX Design',
		tagline: 'Thoughtful UI/UX design that makes digital products intuitive, accessible, and easy to navigate.',
		summary:
	...
	//Payment integration
	{
		...
		tagline: 'Secure payment integrations that make checkout seamless across your websites and applications.',
		summary:
	...
	//Maintenance & support
	{
		...
		tagline: 'Proactive support and maintenance that keep your applications secure, stable, and running smoothly.',
		summary:
