...
/**
 * Approach — connected stage grid on a light surface.
 */
			...
			<div className="relative mx-auto w-full max-w-6xl px-5 py-20 sm:px-8 md:py-24">
				<div className="max-w-2xl">
					...
					<p className="mt-4 text-[15px] leading-relaxed text-slate-500 sm:text-base">
						A clear, connected path from discovery to a healthy production system —
						adapted to the scope and constraints of this engagement.
					</p>
				</div>
				...
				<div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
					{project.approach.map((step) => (
						<div
							key={step.phase}
							className="group relative flex gap-5 rounded-2xl border border-slate-200/80 bg-[#F8FAFC] p-6 transition-all hover:-translate-y-0.5 hover:border-brand/40 hover:shadow-lg hover:shadow-navy/5 sm:p-7"
						>
