	...
	return (
		<div className="relative mx-auto mt-14 w-full max-w-md lg:mt-0 lg:max-w-none">
			...
			<div className="relative min-h-[420px] sm:min-h-[460px] lg:min-h-[520px]">
				...
				>
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-2">
							...
							<p className="text-[13px] font-semibold text-navy">Sectors</p>
						</div>
					...
					<div className="mt-4 grid grid-cols-3 gap-2">
						{['Fin', 'Shop', 'Care', 'Edu', 'Real', 'Pro', 'Logi', 'Travel', 'Tech'].map((label, i) => (
							<span
								key={label}
								className={`rounded-lg px-2 py-2.5 text-center text-[11px] font-semibold ${
									i === 8
										? 'bg-brand text-white'
				...
				>
					<p className="text-[12px] font-semibold text-navy">Domain-first</p>
					<p className="mt-2 text-[11px] leading-relaxed text-slate-400">
						We start from the language and constraints of your field.
					</p>
				</div>
				...
				>
					...
					<span className="text-[12px] font-semibold text-navy">Sector expertise</span>
				</div>
			...
			<div className="relative mx-auto w-full max-w-7xl px-5 pb-24 pt-32 sm:px-8 md:pt-40 lg:pb-28">
				<div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-8">
					<div className="lg:col-span-7">
						...
						>
							We work across sectors where domain knowledge matters. Each engagement
							starts from the constraints, language and goals of your field — so the
							product fits the way your industry actually works.
						</p>
