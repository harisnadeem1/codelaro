...
/* ---------- browser mockup with editable screenshot placeholder ---------- */
...
export function Work() {
	return (
		<section id="work" className="relative scroll-mt-24 overflow-hidden bg-navy-900">
			<span
				aria-hidden
			...
			<div className="relative mx-auto w-full max-w-7xl px-5 py-20 sm:px-8 md:py-28">
				<div className="max-w-2xl">
					...
					<p className="mt-5 max-w-xl text-base leading-relaxed text-slate-400 sm:text-lg">
						...
						below is a placeholder — swap in the real project, client and outcome when
				...
				<div className="mt-16 flex justify-center border-t border-white/10 pt-12">
					<Link
						to="/work"
						className="inline-flex h-12 items-center gap-2 rounded-lg border border-white/15 bg-white/[0.04] px-7 font-display text-[15px] font-semibold text-white transition-all hover:border-brand hover:bg-brand/10 hover:text-brand active:scale-[0.98]"
					>
						View all work
						<ArrowUpRight className="h-4 w-4" />
					</Link>
