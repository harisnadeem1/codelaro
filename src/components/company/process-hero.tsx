	...
	return (
		<div className="relative mx-auto mt-14 w-full max-w-md lg:mt-0 lg:max-w-none">
			...
			<div className="relative min-h-[420px] sm:min-h-[460px] lg:min-h-[520px]">
				...
				>
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-2">
							...
							<p className="text-[13px] font-semibold text-navy">The journey</p>
						</div>
				...
				>
					<p className="text-[12px] font-semibold text-navy">One connected path</p>
					<p className="mt-2 text-[11px] leading-relaxed text-slate-400">
						From first idea to lasting growth — grouped into three movements.
					</p>
				</div>
				...
				>
					...
					<span className="text-[12px] font-semibold text-navy">Code → Grow</span>
				</div>
			...
			<div className="relative mx-auto w-full max-w-7xl px-5 pb-24 pt-32 sm:px-8 md:pt-40 lg:pb-28">
				<div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-8">
					<div className="lg:col-span-7">
						...
						>
							Six disciplined stages — Discover, Strategize, Design, Code, Launch and
							Grow — grouped into the three movements that define every Codelaro
							engagement.
						</p>
